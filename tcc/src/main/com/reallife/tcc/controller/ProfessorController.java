...
public class ProfessorController {
    ...
    private final AulaService aulaService; // ADICIONE ESTA LINHA
    ...
    // ========== GERENCIAMENTO DE AULAS COLETIVAS ==========
    @PostMapping("/aulas")
    public ResponseEntity<Aulas> criarAula(@RequestBody Aulas aula) {
        try {
            Aulas aulaSalva = aulaService.criarAula(aula);
    ...
    @GetMapping("/{professorId}/aulas")
    public ResponseEntity<List<Aulas>> verMinhasAulas(@PathVariable Long professorId) {
        try {
            List<Aulas> aulas = aulaService.listarAulasDoProfessor(professorId);
    ...
    public ResponseEntity<Aulas> buscarAula(@PathVariable Long aulaId) {
        try {
    ...
    @PutMapping("/aulas/{aulaId}")
    public ResponseEntity<Aulas> atualizarAula(@PathVariable Long aulaId, @RequestBody Aulas aula) {
        try {
            Aulas aulaAtualizada = aulaService.atualizarAula(aulaId, aula);
    ...
    @DeleteMapping("/aulas/{aulaId}")
    public ResponseEntity<Void> deletarAula(@PathVariable Long aulaId) {
        try {
            aulaService.deletarAula(aulaId);
            return ResponseEntity.noContent().build();
        } catch (RuntimeException e) {
            return ResponseEntity.notFound().build();
        }
    ...
    @PatchMapping("/aulas/{aulaId}/ativar")
    public ResponseEntity<Aulas> ativarAula(@PathVariable Long aulaId) {
        try {
            Aulas aula = aulaService.ativarAula(aulaId);
            return ResponseEntity.ok(aula);
        } catch (RuntimeException e) {
            return ResponseEntity.notFound().build();
        }
    ...
    @PatchMapping("/aulas/{aulaId}/desativar")
    public ResponseEntity<Aulas> desativarAula(@PathVariable Long aulaId) {
        try {
            Aulas aula = aulaService.desativarAula(aulaId);
            return ResponseEntity.ok(aula);
        } catch (RuntimeException e) {
            return ResponseEntity.notFound().build();
        }
